...
public partial class ProviderManagementViewModel : ObservableObject
{
    ...
    public ProviderManagementViewModel(IConfigurationService configService)
    {
    ...
    [RelayCommand]
    public void EditProvider(ProviderConfig? provider)
    {
    ...
    public static string? ValidateApiKeyFormat(AIProviderType providerType, string apiKey)
    {
